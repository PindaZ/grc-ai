...
export const AgentStatusWidget = () => {
    ...
    const workforceStats = [
        { label: 'System Compliance', value: 94, color: 'success' as const, icon: <CheckmarkCircleRegular /> },
        { label: 'Agent Uptime', value: 99.8, color: 'brand' as const, icon: <PulseRegular /> },
        { label: 'Task Throughput', value: 82, color: 'brand' as const, icon: <BotRegular /> },
    ];
        ...
        <div className={styles.container}>
            ...
            <Link href="/execution" className={styles.statusFooter}>
                ...
                <Text size={100} style={{ color: tokens.colorNeutralForeground3 }}>
                    8 autonomous agents are currently active. 2 tasks require human verification in the Action Center.
                </Text>
            </Link>
        </div>
    );
